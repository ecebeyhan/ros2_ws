...
#include "srvs/msg/detail/sensor_type__rosidl_typesupport_fastrtps_c.h"
...
using _SensorType__ros_msg_type = srvs__msg__SensorType;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _SensorType__ros_msg_type * ros_message = static_cast<const _SensorType__ros_msg_type *>(untyped_ros_message);
  ...
  void * untyped_ros_message)
{
  ...
  _SensorType__ros_msg_type * ros_message = static_cast<_SensorType__ros_msg_type *>(untyped_ros_message);
  // Field name: sensor_type
  {
    cdr >> ros_message->sensor_type;
  }
...
static uint32_t _SensorType__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_srvs__msg__SensorType(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = srvs__msg__SensorType;
    is_plain =
      (
...
static size_t _SensorType__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_srvs__msg__SensorType(
...
static message_type_support_callbacks_t __callbacks_SensorType = {
  "srvs::msg",
  "SensorType",
