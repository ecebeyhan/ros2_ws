...
static const _SensorType_type_support_symbol_names_t _SensorType_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, srvs, msg, SensorType)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, srvs, msg, SensorType)),
  }
};
...
{
  return &::srvs::msg::rosidl_typesupport_cpp::SensorType_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, srvs, msg, SensorType)() {
  return get_message_type_support_handle<srvs::msg::SensorType>();
}
