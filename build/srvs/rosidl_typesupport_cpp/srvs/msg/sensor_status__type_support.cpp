...
static const _SensorStatus_type_support_symbol_names_t _SensorStatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, srvs, msg, SensorStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, srvs, msg, SensorStatus)),
  }
};
...
{
  return &::srvs::msg::rosidl_typesupport_cpp::SensorStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, srvs, msg, SensorStatus)() {
  return get_message_type_support_handle<srvs::msg::SensorStatus>();
}
