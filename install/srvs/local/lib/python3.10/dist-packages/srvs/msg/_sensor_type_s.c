...
bool srvs__msg__sensor_type__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("srvs.msg._sensor_type.SensorType", full_classname_dest, 32) == 0);
  }
  srvs__msg__SensorType * ros_message = _ros_message;
  {  // sensor_type
...
{
  /* NOTE(esteve): Call constructor of SensorType */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("srvs.msg._sensor_type");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SensorType");
